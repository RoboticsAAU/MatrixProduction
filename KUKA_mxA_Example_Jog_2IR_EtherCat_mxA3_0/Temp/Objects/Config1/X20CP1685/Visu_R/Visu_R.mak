...
PANEL_HW_SOURCE_Visu_R=C:/Users/danie/OneDrive/Documents/Github/MatrixProduction/KUKA_mxA_Example_Jog_2IR_EtherCat_mxA3_0/Physical/Config1/Hardware.hw 
DIS_OBJECTS_Visu_R=$(PANEL_HW_OBJECT_Visu_R) $(KEYMAP_OBJECTS_Visu_R)

# KeyMapping flags
$(TEMP_PATH_Visu_R)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/Config1/X20CP1685/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu_R)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu_R)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu_R)/dis.PS2-Keyboard.vco)' -n Visu_Resized -d Visu_R -pal '$(PALFILE_Visu_R)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'B4.91' -L '' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu_R) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/Config1/X20CP1685/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.72.6/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'KUKA_mxA_Example_Jog_2IR_EtherCat_mxA3_0' -sfas -vcob '$(VCOBJECT_Visu_R)'
...
KEYMAP_SOURCES_Visu_R=$(AS_PROJECT_PATH)/Physical/Config1/X20CP1685/VC/PS2-Keyboard.dis 
...
$(PANEL_HW_VCI_Visu_R): $(PANEL_HW_SOURCE_Visu_R) $(VC_LIBRARY_LIST_Visu_R) $(KEYMAP_SOURCES_Visu_R) $(PALFILE_Visu_R)
	$(VCHWPP) -f '$<' -o '$@' -n Visu_Resized -d Visu_R -pal '$(PALFILE_Visu_R)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'B4.91' -L '' -verbose 'False' -profile 'False' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu_R) -sos $(VC_STATIC_OPTIONS_Shared) -fp '$(AS_VC_PATH)/Firmware/V4.72.6/SG4' -sfas -prj '$(AS_PROJECT_PATH)' -apj 'KUKA_mxA_Example_Jog_2IR_EtherCat_mxA3_0' -vcob '$(VCOBJECT_Visu_R)'
...
$(TEMP_PATH_Visu_R)/page.JogMode.vco: $(AS_PROJECT_PATH)/Logical/Visu_Resized/Pages/JogMode.page $(VC_LANGUAGES_Visu_R)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu_R)' $(VCCFLAGS_Visu_R) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu_R)/StyleSheets/Color.vcs' -p Visu_R -so $(VC_STATIC_OPTIONS_Visu_R) -vcr 4726 -sfas
